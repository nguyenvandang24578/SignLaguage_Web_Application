...
import numpy as np
import math
from models.dropSke import DropBlock_Ske
from models.dropT import DropBlockT_1d
...
class Model(nn.Module):
    ...
    def forward(self, x, keep_prob=1, is_feat=False):
        N, C, T, V, M = x.size()
...
def sl_gcn_joint_wlasl100(num_classes):
    return Model(
        num_class=num_classes,
        num_point=27,
        num_person=1,
...
def sl_gcn_joint_motion(num_classes):
    return Model(
        num_class=num_classes,
        num_point=27,
        num_person=1,
...
def sl_gcn_bone_motion(num_classes):
    return Model(
        num_class=num_classes,
        num_point=27,
        num_person=1,
