...
def tdgcn_joint(num_classes=226):
    return Model(
        num_class=num_classes,
        num_point=27,
        num_person=1,
        graph='graph_TDGCN.ntu_rgb_d.Graph',
        graph_args={'labeling_mode': 'spatial'}
    )
def tdgcn_joint_wlasl100(num_classes=100):
    return Model(
        num_class=num_classes,
        num_point=27,
        num_person=1,
...
def tdgcn_bone(num_classes=226):
    return Model(
        num_class=num_classes,
        num_point=27,
        num_person=1,
...
def tdgcn_joint_motion(num_classes=226):
    return Model(
        num_class=num_classes,
        num_point=27,
        num_person=1,
...
def tdgcn_bone_motion(num_classes=226):
    return Model(
        num_class=num_classes,
        num_point=27,
        num_person=1,
