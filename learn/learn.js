...
const TOPICS = [
  ...
  },
  {
    ...
    words: [
      ...
      { label: 'Ô',        videoFile: 'oo.mp4',    glbFile: 'oo.glb',    desc: '<strong>Nguyên âm Ô:</strong> Ký hiệu chữ O, thêm động tác phụ biểu thị dấu mũ.' },
      { label: 'Ơ',        videoFile: 'ow.mp4',    glbFile: 'ow.glb',    desc: '<strong>Nguyên âm Ơ:</strong> Ký hiệu chữ O, thêm động tác phụ biểu thị dấu móc.' },
